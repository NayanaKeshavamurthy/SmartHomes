...
public class PrevAccessory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		All the Doorbells and doorbells information are dispalyed in the Content Section
	...
	//	int i = 1; int size= hm.size();
		...
		{
			DoorBells db = entry.getValue();
			if (db.getName().equals(ProductName))
			{
			pw.print("<tr>");
			pw.print("<td><div id='shop_item'>");
			pw.print("<h3>"+db.getName()+"</h3>");
			pw.print("<strong>$"+db.getPrice()+"</strong><ul>");
			pw.print("<li id='item'><img src='images/doorbells/"+db.getImage()+"' alt='' /></li>");
		...
		pw.print("</h2><div class='entry'><table id='bestseller'>");
		DoorBells db1 = hm.get(ProductName);
		System.out.print(ProductName);
		int i = 1; int size= hm.size();
		pw.print("<tr>");
		ArrayList<String> arr = new ArrayList<String> ();
		for(Map.Entry<String, String> acc:db1.getAccessories().entrySet())
		{
