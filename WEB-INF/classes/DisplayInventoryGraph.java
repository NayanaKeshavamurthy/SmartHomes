...
@WebServlet("/DisplayInventoryGraph")

public class DisplayInventoryGraph extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
        ...
        out.print("<article> <h1 align=\"center\"><span style='color:#0a80a3;padding: 2px;'>"+"Product Inventory Display</span></h1> ");
        ...
        out.print("<div id=\"inventory_barchart\"  style='margin-top: 2px;' ></div>");
