...
public class DisplayProducts extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
        ...
        out.print("<section id='content' style=\"background-color:white;width:70%\">");
        out.print("<article> <h1 align=\"center\"><span style='color:#0a80a3;'>"+"All Products Inventory</span></h1> ");
        ...
        out.print("<div id=\"table_allProds\" ></div>");
