...
@WebServlet("/DisplayRebateProduct")

public class DisplayRebateProduct extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
        ...
        out.print("<article> <h1 align=\"center\"><span style='color:#0a80a3;'>"+"Products on Rebate</span></h1> ");
        ...
        out.print("<div id=\"table_RebateProds\" ></div>");
