...
public class NextAccessory extends HttpServlet {
	...
	/* Tv Page Displays all the Tvs and their Information in Smart Home */
	...
	//	int i = 1; int size= hm.size();
		for(Map.Entry<String, DoorBells> entry : hm.entrySet())
		{
			...
			if (doorBell.getName().equals(ProductName))
			{
			pw.print("<tr>");
		...
		pw.print("</h2><div class='entry'><table id='bestseller'>");
		DoorBells doorbells1 = hm.get(ProductName);
		System.out.print(ProductName);
		int i = 1; int size= hm.size();
		pw.print("<tr>");
		ArrayList<String> arr = new ArrayList<String> ();
		for(Map.Entry<String, String> acc:doorbells1.getAccessories().entrySet())
		{
